...
test("clicking Code tab shows the code editor and file tree", async () => {
...
test("clicking Preview tab after Code shows the preview frame", async () => {
  const user = userEvent.setup();
  render(<MainContent />);
...
test("toggling back to Preview restores Preview tab as active", async () => {
  const user = userEvent.setup();
  render(<MainContent />);
